...
metadata:
  dcc-mcp:
    ...
    search-hint: >-
      import file, import fbx, import obj, import usd, import USD, export gltf,
      export usd, export alembic, batch export, interchange, pipeline, game export
    tools: tools.yaml
---
...
export. Existing `blender-geometry` exposes FBX/OBJ export names and delegates to
